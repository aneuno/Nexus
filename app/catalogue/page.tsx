...
export default function CataloguePage() {
  ...
  useEffect(() => {
    ...
    if (filterUniverse !== 'all') {
      result = result.filter(c => c.universe === filterUniverse)
    }
    setFiltered(result)
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#0a0a14', color: '#e8e0cc', fontFamily: 'sans-serif' }}>
      ...
      >
        <a href="/" style={{ fontSize: '0.8rem', color: 'rgba(201,168,76,0.5)', textDecoration: 'none' }}>
          Menu
        </a>
              ...
              >
                <div
                  style={{
                    ...
                    overflow: 'hidden',
                    background: '#141428',
                    border: `1px solid ${getRarityColor(card.rarity)}60`,
                    display: 'flex',
                    alignItems: 'center',
          ...
          >
            ...
            <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start' }}>
              <div style={{ flexShrink: 0, display: 'flex', flexDirection: 'column', gap: '10px' }}>
                <div
                  style={{
                    ...
                    overflow: 'hidden',
                    background: '#141428',
                    border: `2px solid ${getRarityColor(selected.rarity)}`,
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                  }}
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ fontSize: '0.78rem', color: getRarityColor(selected.rarity), marginBottom: '12px' }}>
                  {selected.rarity}
                </div>
